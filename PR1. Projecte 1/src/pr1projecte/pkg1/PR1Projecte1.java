...
public class PR1Projecte1 {
    ...
    private static final String TABLA_LINEA = "-------------------------------------------------";
        ...
        if (i <= 3 && dadaCorrecta) {
            ...
            do {
                ...
                if (dadaCorrecta) {
                    ...
                    if (tipus == 0) {
                        System.out.println(TABLA_LINEA);
                        System.out.println("| id | \tedat | \ttipus | importcompra | \ttelefon\t |");
                        System.out.println("|-----------------------------------------------|");
                        System.out.println("| " + id + " |" + "\t" + edat + " |" + "\t" + "Venda lliure" + " |" + "\t" + importcompra + " |" + "\t" + telefon + "|" + "\t");
                        System.out.println(TABLA_LINEA);
                    }
                    if (tipus == 1) {
                        System.out.println(TABLA_LINEA);
                        System.out.println("| id | \tedat | \ttipus | importcompra | \ttelefon\t |");
                        System.out.println("|-----------------------------------------------|");
                        System.out.println("| " + id + " |" + "\t" + edat + " |" + " Pensionista" + " | " + importcompra + "\t|"  + telefon + "|" + "\t");
                        System.out.println(TABLA_LINEA);
                    }
                    if (tipus == 2) {
                        System.out.println(TABLA_LINEA);
                        System.out.println("| id | \tedat | \ttipus | importcompra | \ttelefon\t |");
                        System.out.println("|-----------------------------------------------|");
                        System.out.println("| " + id + " |" + "\t" + edat + " |" + " Carnet Jove" + " | " + importcompra + " \t |" + "\t" + telefon + "|" + "\t");
                        System.out.println(TABLA_LINEA);
                    }
                    if (tipus == 3) {
                        System.out.println(TABLA_LINEA);
                        System.out.println("| id | \tedat | \ttipus | importcompra | \ttelefon\t |");
                        System.out.println("|-----------------------------------------------|");
                        System.out.println("| " + id + " |" + "\t" + edat + " |" + "\t" + "Soci" + " |" + "\t" + importcompra + " \t |" + "\t" + telefon + "|" + "\t");
                        System.out.println(TABLA_LINEA);
                    }
                }
                i++;
